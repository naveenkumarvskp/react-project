...
const UserDetails = ({
  ...
  }, [isUserDeleteSuccessfully, restUserDeleteNotification]);
  ...
  return (
    <>
        ...
        <div className="container">
          {isUserDeleteSuccessfully && (
            <div class="alert alert-warning" role="alert">
              ...
              <p>
                If you want add user then please go add user info page and add
                the user.
              </p>
            </div>
          )}
                ...
                <div className="card shadow-sm">
                  <div className="card-body">
                    ...
                    <div className="mt-4 d-flex flex-column align-items-center">
                      ...
                      {isDeleteUserLoading && selectedBtnId === user.id ? (
                        <div className="my-3">
                          <LoadingIndicator />
                        </div>
                      ) : (
                        <button
                          ...
                          onClick={() => deleteUserInfo(user.id)}
                        >
                          Delete
                        </button>
                      )}
      ...
      <ModalInfo
        ...
        userInfo={showModal.userDetails}
      />
      <EditUserInfoModal
        show={openEditModal.isEditModalOpen}
        handleClose={editModalClose}
        userInfo={openEditModal.EditUserDetails}
      />
    </>
  );
};
